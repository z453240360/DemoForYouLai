...
import com.yl.crazy.mydongtest.ShoppingCar.ShoppingChildAdapter;
...
public class ShoppingCarChildView extends FrameLayout {
    ...
    public ShoppingCarChildView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public ShoppingCarChildView(Context context) {
        this(context,null);
    }

    public ShoppingCarChildView(Context context, AttributeSet attrs) {
