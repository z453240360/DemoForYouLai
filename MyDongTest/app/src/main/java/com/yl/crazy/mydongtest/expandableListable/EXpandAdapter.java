...
public class EXpandAdapter extends BaseExpandableListAdapter {
    ...
    public EXpandAdapter(List<CarBean.DataBeanX.DataBean> mDatas, Context mContext) {
        this.mDatas = mDatas;
    ...
    public View getGroupView(final int postion, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (dongdong >= mDatas.get(postion).getMin_pay_money()) {
            ...
            groupHolder.postMoney.setTextColor(Color.parseColor("#000000"));
        }
        ...
        groupHolder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mDatas.get(postion).isFlag()) {
                    ...
                    groupHolder.checkBox.setImageResource(R.drawable.shopcart_shop);
                    mDatas.get(postion).setFlag(false);
                    setAllChildSelect(postion, false);

                } else {
                    mDatas.get(postion).setSelect(true);
                    groupHolder.checkBox.setImageResource(R.drawable.shopcart_add_red);
        ...
        if (mDatas.get(postion).isSelect()) {
            groupHolder.checkBox.setImageResource(shopcart_add_red);
        } else {
            groupHolder.checkBox.setImageResource(R.drawable.shopcart_shop);
        }
    ...
    public View getChildView(final int i, final int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        childHolder.money.setText("小计：" + mDatas.get(i).getGoods().get(i1).getChildTotalPrice() + "元");
